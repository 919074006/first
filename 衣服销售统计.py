...
print("总金额为：￥", (469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6),"元")
print("平均日销售量：",format((469 + 120 + 292 + 517 + 207 + 239)/30,'.1f'))
print("T恤本月销售额占比：",format((469*65.8)/(469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6)*100,'.1f'),"%")
print("衬衫本月销售额占比：",format((120*49.3)/(469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6)*100,'.1f'),"%")
print("风衣本月销售额占比：",format((292*96.8)/(469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6)*100,'.1f'),"%")
print("牛仔裤本月销售额占比：",format((517*86.3)/(469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6)*100,'.1f'),"%")
print("皮草本月销售额占比：",format((207*135.9)/(469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6)*100,'.1f'),"%")
print("羽绒服本月销售额占比：",format((239*253.6)/(469*65.8 + 120*49.3 + 292*96.8 + 517*86.3 + 207*135.9 + 239*253.6)*100,'.1f'),"%")